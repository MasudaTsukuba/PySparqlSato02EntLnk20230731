...
if __name__ == '__main__':
    ...
    db = DataBase(path, 'landmark.db')  # set the database instance
    tables = [
    ...
    db.create_database(tables)  # create database
    sqls = [
    ...
    db.insert_data(path_tables, sqls)  # insert data in CSV files into database tables
